...
function FullFaceRelaxationYogaAsanas () {
  ...
  return (
    <div style={containerStyle}>
      <BackButton />
      <h1>Full Face Relaxation Yoga Asanas</h1>
      <div style={boxStyle}>
        ...
        <a href="https://youtu.be/ZkyN4Dy4kO0?si=TRNn5M9tqEHWp8yQ" target="_blank" rel="noopener noreferrer" style={linkStyle} onMouseOver={(e) => (e.currentTarget.style.textDecoration = linkHoverStyle.textDecoration)} onMouseOut={(e) => (e.currentTarget.style.textDecoration = linkStyle.textDecoration)}>
          Watch on YouTube
        </a>
      </div>
      <div style={boxStyle}>
        ...
        <a href="https://youtu.be/Ppku7i3ypGM?si=JlNSNnes9V_NcdUi" target="_blank" rel="noopener noreferrer" style={linkStyle} onMouseOver={(e) => (e.currentTarget.style.textDecoration = linkHoverStyle.textDecoration)} onMouseOut={(e) => (e.currentTarget.style.textDecoration = linkStyle.textDecoration)}>
          Watch on YouTube
        </a>
      </div>
      <div style={boxStyle}>
        ...
        <a href="https://youtu.be/99fx_TMX7rk?si=IvrkKhOKjHjWnLaf" target="_blank" rel="noopener noreferrer" style={linkStyle} onMouseOver={(e) => (e.currentTarget.style.textDecoration = linkHoverStyle.textDecoration)} onMouseOut={(e) => (e.currentTarget.style.textDecoration = linkStyle.textDecoration)}>
          Watch on YouTube
        </a>
      </div>
      <BackButton />
...
export default FullFaceRelaxationYogaAsanas;
