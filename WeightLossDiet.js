...
function WeightLossDiet () {
  ...
  return (
    <div style={containerStyle}>
      <h1>Weight Loss Diet </h1><br/>
      <h3>Select the Type of Diet :</h3>
      <div style={optionsStyle}>
        <Link to="/diet/weight-loss-diet/low-fat-diet" style={optionButtonStyle}>Low-Fat Diet </Link>
        <Link to="/diet/weight-loss-diet/vegan-diet" style={optionButtonStyle}>Vegan Diet </Link>
        <Link to="/diet/weight-loss-diet/whole-30-diet" style={optionButtonStyle}>Whole-30 Diet </Link>
      </div>
      <BackButton />
    </div>
  );
